...
> **⚠️ TODO:** Текущая архитектура требует оптимизации для реалтайм-игр. См. [План рефакторинга системы карт](./09_map_optimization_refactoring_plan.md) для деталей оптимизации производительности и синхронизации.
